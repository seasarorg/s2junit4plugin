...
public class JavaElements {
	...
	public static boolean isTestMethod(IJavaElement element) throws JavaModelException {
		...
		if (hasS2JUnit4Annotation((IType) element.getParent()))
			return true;
	...
	private static boolean isStaticSuiteMethod(IMethod method) throws JavaModelException {
		return ((method.getElementName().equals("suite")) && method.getSignature().equals("()QTest;") && Flags.isPublic(method.getFlags()) && Flags.isStatic(method.getFlags()));
	}
}
