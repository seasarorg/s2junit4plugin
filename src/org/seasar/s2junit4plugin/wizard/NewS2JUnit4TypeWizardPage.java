 ...
 * @since 2.0
 */
public abstract class NewS2JUnit4TypeWizardPage extends NewContainerWizardPage {
	 ...
	 */
	public NewS2JUnit4TypeWizardPage(boolean isClass, String pageName) {
	 ...
	 * @since 3.1
	 */
	public NewS2JUnit4TypeWizardPage(int typeKind, String pageName) {
	    super(pageName);
	    fTypeKind= typeKind;
	...
	protected void chooseSuperInterfaces() {
		...
		S2JUnit4SuperInterfaceSelectionDialog dialog= new S2JUnit4SuperInterfaceSelectionDialog(getShell(), getWizard().getContainer(), this, project);
